...
class PlaneModel
{
     ...
     * Add plan
     *
     * @param \WCS\CoavBundle\Entity\Flight $plan
     *
     * @return PlaneModel
     */
    public function addPlan(\WCS\CoavBundle\Entity\Flight $plan)
    {
        $this->plans[] = $plan;
     ...
     * @param \WCS\CoavBundle\Entity\Flight $plan
     */
    public function removePlan(\WCS\CoavBundle\Entity\Flight $plan)
    {
